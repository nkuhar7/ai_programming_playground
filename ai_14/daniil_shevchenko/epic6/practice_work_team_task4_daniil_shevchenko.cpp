...
Tree reflecttree(Tree input)
{
    input.reflect(input.root);
    return input;
}
int main()
{
    ...
    test.preorderbypass();
    cout << endl;
    Tree test2 = reflecttree(test);
    cout << "Output in depth after reflecting" << endl;
    test2.inorderbypass();
    cout << endl;
    cout << "Output in width after reflecting" << endl;
    test2.preorderbypass();
