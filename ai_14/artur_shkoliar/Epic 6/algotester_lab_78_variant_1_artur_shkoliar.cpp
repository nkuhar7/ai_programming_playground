...
public:
    ...
    void insertNode(int index, int N, int arr[])
    {
        if (index > SizeOfList()) 
        {
            return;
    ...
    void setNodeValue(int index, int content) 
    {
        Node* traverser = getNode(index);
...
int main() 
{
    ...
    while (Q--) 
    {
        ...
        else if (request == "set") 
        {
            ...
            int content;
            cin >> index >> content;
            list.setNodeValue(index, content);
        }
        ...
        else if (request == "get") 
        {
            ...
            cout << list.getNodeValue(index) << endl;
        }
