...
string books[4] = {"Institute", "It", "The Shining", "Fairy Tale"};
string availability[4] = {"Available", "Available", "Available", "Available"};
...
cin >> answer;
    ...
    if (answer == 1) {
        ...
        Takebook:
        cout << "Whick book do you want to take?(1-4)" << endl;
        cout << "5 - Back" << endl;
        cin >> bookchoise;
        ...
        Returnbook:
        cout << "Which book do you want to return?(1-4)" << endl;
        cout << "5 - Back" << endl;
        cin >> bookchoise;
